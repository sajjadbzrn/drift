  ...
  build: {
    ...
    rollupOptions: {
      output: {
        ...
        // Split the heavy vendors out of the app entry: the three.js backdrop
        // and React then load in parallel and stay cached across app updates,
        // so only the small app chunk has to be re-parsed on each release.
        manualChunks: {
          three: ["three"],
